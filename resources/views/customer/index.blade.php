...
<body>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-end">
                        <div class="row">
                            <div class="col-md-3">
                                <select id="genderCustomer" class="form-control">
    ...
    <script>
        $("#genderCustomer").on('change', function() {
            let gender = $("#genderCustomer").val();
            // alert(gender);
            if(gender) {
                $.ajax({
                    type    : "POST",
                    ...
                    success : function(data) {
                        console.log(data);
                        $("#showTableInfo").html(data);
                    },
                });
            }else {
                alert('Gender not defiend');
            }
        });
    </script>
</body>
